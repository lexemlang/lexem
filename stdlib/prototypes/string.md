...
- [Methods](#methods)
  - [.length() -&gt; Integer](#length--gt-integer)
  - [.toString() -&gt; String](#tostring--gt-string)
  - [.charsAt(...indexes: List&lt;Integer | Interval&gt;) -&gt; String](#charsatindexes-listltinteger--intervalgt--gt-string)
  - [.unicodePointsAt(...indexes: List&lt;Integer | Interval&gt;) -&gt; List&lt;Int&gt;](#unicodepointsatindexes-listltinteger--intervalgt--gt-listltintgt)
  - [.endsWithAny(...suffixes: List&lt;String&gt;) -&gt; Logic](#endswithanysuffixes-listltstringgt--gt-logic)
  - [.startsWithAny(...prefixes: List&lt;String&gt;) -&gt; Logic](#startswithanyprefixes-listltstringgt--gt-logic)
  - [.containsAny(...substrings: List&lt;String&gt;) -&gt; Logic](#containsanysubstrings-listltstringgt--gt-logic)
  - [.containsAll(...substrings: List&lt;String&gt;) -&gt; Logic](#containsallsubstrings-listltstringgt--gt-logic)
  - [.indexOf(substring: String) -&gt; Integer | Nil](#indexofsubstring-string--gt-integer--nil)
  - [.lastIndexOf(substring: String) -&gt; Integer | Nil](#lastindexofsubstring-string--gt-integer--nil)
  - [.padStart(length: Integer, padString: String = &quot; &quot;) -&gt; String](#padstartlength-integer-padstring-string--quot-quot--gt-string)
  - [.padEnd(length: Integer, padString: String = &quot; &quot;) -&gt; String](#padendlength-integer-padstring-string--quot-quot--gt-string)
  - [.repeat(count: Integer) -&gt; String](#repeatcount-integer--gt-string)
  - [.repeat(count: Integer, separator: String) -&gt; String](#repeatcount-integer-separator-string--gt-string)
  - [.replace(original: String, replace: String) -&gt; String](#replaceoriginal-string-replace-string--gt-string)
  - [.replace(original: String, replace: String, insensible: Logic) -&gt; String](#replaceoriginal-string-replace-string-insensible-logic--gt-string)
  - [.slice(from: Integer) -&gt; String](#slicefrom-integer--gt-string)
  - [.slice(from: Integer, count: Integer) -&gt; String](#slicefrom-integer-count-integer--gt-string)
  - [.split(substring: String) -&gt; List&lt;String&gt;](#splitsubstring-string--gt-listltstringgt)
  - [.toLowercase() -&gt; String](#tolowercase--gt-string)
  - [.toUppercase() -&gt; String](#touppercase--gt-string)
  - [.trimStart() -&gt; String](#trimstart--gt-string)
  - [.trimEnd() -&gt; String](#trimend--gt-string)
  - [.trim() -&gt; String](#trim--gt-string)
- [Operators](#operators)
  - [.add(right: Any) -&gt; String](#addright-any--gt-string)
- [Accesses](#accesses)
  - [[index: Integer] -&gt; String](#index-integer--gt-string)
