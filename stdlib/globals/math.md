...
- [Methods](#methods)
  - [.abs(number: Integer | Float) -&gt; Integer | Float](#absnumber-integer--float--gt-integer--float)
  - [.acos(number: Integer | Float) -&gt; Float | Nil](#acosnumber-integer--float--gt-float--nil)
  - [.acosh(number: Integer | Float) -&gt; Float | Nil](#acoshnumber-integer--float--gt-float--nil)
  - [.asin(number: Integer | Float) -&gt; Float | Nil](#asinnumber-integer--float--gt-float--nil)
  - [.asinh(number: Integer | Float) -&gt; Float](#asinhnumber-integer--float--gt-float)
  - [.atan(number: Integer | Float) -&gt; Float](#atannumber-integer--float--gt-float)
  - [.atanh(number: Integer | Float) -&gt; Float | Nil](#atanhnumber-integer--float--gt-float--nil)
  - [.atan2(x: Integer | Float, y: Integer | Float) -&gt; Float](#atan2x-integer--float-y-integer--float--gt-float)
  - [.cbrt(number: Integer | Float) -&gt; Float](#cbrtnumber-integer--float--gt-float)
  - [.ceil(number: Integer | Float) -&gt; Integer](#ceilnumber-integer--float--gt-integer)
  - [.clz32(number: Integer) -&gt; Integer](#clz32number-integer--gt-integer)
  - [.cos(number: Integer | Float) -&gt; Float](#cosnumber-integer--float--gt-float)
  - [.cosh(number: Integer | Float) -&gt; Float](#coshnumber-integer--float--gt-float)
  - [.exp(number: Integer | Float) -&gt; Float](#expnumber-integer--float--gt-float)
  - [.floor(number: Integer | Float) -&gt; Integer](#floornumber-integer--float--gt-integer)
  - [.hypot(...numbers: List&lt;Integer | Float&gt;) -&gt; Float](#hypotnumbers-listltinteger--floatgt--gt-float)
  - [.ln(number: Integer | Float) -&gt; Float](#lnnumber-integer--float--gt-float)
  - [.log10(number: Integer | Float) -&gt; Float](#log10number-integer--float--gt-float)
  - [.log2(number: Integer | Float) -&gt; Float](#log2number-integer--float--gt-float)
  - [.max(...numbers: List&lt;Integer | Float&gt;) -&gt; Float](#maxnumbers-listltinteger--floatgt--gt-float)
  - [.min(...numbers: List&lt;Integer | Float&gt;) -&gt; Float](#minnumbers-listltinteger--floatgt--gt-float)
  - [.pow(base: Integer | Float, exponent: Integer | Float) -&gt; Float | Nil](#powbase-integer--float-exponent-integer--float--gt-float--nil)
  - [.random() -&gt; Float](#random--gt-float)
  - [.round(number: Integer | Float) -&gt; Integer](#roundnumber-integer--float--gt-integer)
  - [.sign(number: Integer | Float) -&gt; Integer](#signnumber-integer--float--gt-integer)
  - [.sin(number: Integer | Float) -&gt; Float](#sinnumber-integer--float--gt-float)
  - [.sinh(number: Integer | Float) -&gt; Float](#sinhnumber-integer--float--gt-float)
  - [.sqrt(number: Integer | Float) -&gt; Float | Nil](#sqrtnumber-integer--float--gt-float-nil)
  - [.tan(number: Integer | Float) -&gt; Float](#tannumber-integer--float--gt-float)
  - [.tanh(number: Integer | Float) -&gt; Float](#tanhnumber-integer--float--gt-float)
  - [.trunc(number: Integer | Float) -&gt; Integer](#truncnumber-integer--float--gt-integer)
- [Properties](#properties)
  - [.E -&gt; Float](#e--gt-float)
  - [.LN2 -&gt; Float](#ln2--gt-float)
  - [.LN10 -&gt; Float](#ln10--gt-float)
  - [.LOG10_E -&gt; Float](#log10_e--gt-float)
  - [.LOG10_2 -&gt; Float](#log10_2--gt-float)
  - [.LOG2_E -&gt; Float](#log2_e--gt-float)
  - [.LOG2_10 -&gt; Float](#log2_10--gt-float)
  - [.PI -&gt; Float](#pi--gt-float)
  - [.SQRT1_2 -&gt; Float](#sqrt1_2--gt-float)
  - [.SQRT2 -&gt; Float](#sqrt2--gt-float)
  - [.RAD2DEG -&gt; Float](#rad2deg--gt-float)
  - [.DEG2RAD -&gt; Float](#deg2rad--gt-float)
